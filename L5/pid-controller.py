...
def run(param1, param2,param3):
    ...
    # Add Code Here
    # 
    sum_crosstrackerror=0.0
    crosstrack_error1=myrobot.y
    
    for i in range(N):
        crosstrack_error2=myrobot.y
        sum_crosstrackerror+=crosstrack_error2
        steer=-param1* crosstrack_error2-param2*(crosstrack_error2-crosstrack_error1)-param3*sum_crosstrackerror
    
            
        myrobot=myrobot.move(steer,speed)
        crosstrack_error1=crosstrack_error2
